...
<p>Please enter new password: <input type="password" id="field_pwd1" name="field_pwd1"></p>
<p>Please re-enter new password: <input type="password" id="field_pwd2" name="field_pwd2"></p>
