...
$cussql = "SELECT * from customers WHERE id = " .$ordrow['customer_id']. ";";
$cusres = mysqli_query($mysqli,$cussql) or die(mysqli_error($mysqli));
$cusrow = mysqli_fetch_assoc($cusres);
echo "<tr><td><strong>Email</strong></td><td><a href='mailto:" . $cusrow['email'] . "'>". $cusrow['email'] . "</a></td></tr>";
echo "</td>";
echo "</table>";
